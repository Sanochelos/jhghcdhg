...
[
	new Road("road.jpg", 0),
	new Road("road.jpg", canvas.width)
]; //Backgrounds

var player = new Car("car.png", canvas.width / 2, canvas.height / 2, true); //Player's object
...
function Update() 
{
	...
	{
		objects.push(new Car("car_red.png", RandomInteger(30, canvas.width - 50), RandomInteger(250, 400) * -1, false));
	}
